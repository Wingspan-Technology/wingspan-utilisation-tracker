  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Use your Wingspan Google account to access the tracker</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {error === "access_denied" && (
          <p className="text-sm text-destructive text-center rounded-md bg-destructive/10 px-3 py-2">
            Your account is not authorised. Contact an admin to request access.
          </p>
        )}
        <Button
